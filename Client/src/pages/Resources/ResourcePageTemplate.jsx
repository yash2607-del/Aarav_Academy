...
export const ResourcePageTemplate = ({
  ...
  const selectedStream =
    selectedClass?.streams?.find((stream) => stream.id === selectedStreamId) ||
    null;
  const selectedSubject = selectedStream
    ? selectedStream.subjects.find((subj) => subj.id === selectedSubjectId) ||
      null
    : selectedClass?.subjects.find((subj) => subj.id === selectedSubjectId) ||
      null;
              ...
              <div key={cls.id} className="col-6 col-md-4 col-lg-3">
                <button
                  ...
                  onClick={() => {
                    ...
                    setTimeout(() => {
                      const targetSection = cls.streams
                    ...
                    onClick={() => {
                      ...
                      setTimeout(() => {
                        ...
                        if (subjectSection) {
                          const yOffset = -100;
                          const y =
                            subjectSection.getBoundingClientRect().top +
                            window.pageYOffset +
                            yOffset;
                          window.scrollTo({ top: y, behavior: "smooth" });
                        }
